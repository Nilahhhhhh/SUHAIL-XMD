...
global.appUrl=process.env.APP_URL || "render.com"     // put your deploy app/bot url here, for 24/7 for (render , koyeb, glitch)
...
global.devs = "2349066429731" // Developer Contact
...
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "null,2349066429731";
...
module.exports = {
  ...
  caption : global.caption || "Powered by Suhail" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ GlobalTechInfo ® 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@GlobalTechInfo"),
 
  author : process.env.PACK_AUTHER|| "Enny",
  packname: process.env.PACK_NAME || "Nilah",
